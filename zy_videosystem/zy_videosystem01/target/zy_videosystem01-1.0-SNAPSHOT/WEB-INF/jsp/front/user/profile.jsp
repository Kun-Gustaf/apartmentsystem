                ...
                <div class="proflle_tab_workplace clearfix">
                    <div class="profile_avatar_area">
                        ...
                        <c:if test="${not empty user.headUrl}">
                            <img width="200px" height="200px" src="static/img/${user.headUrl}">
                        </c:if>
                    </div>
                    <div class="profile_ifo_area">
                        <form action="${pageContext.request.contextPath}/front/user/toProfile.action?id= ${user.id} "
                              method="post">
                            ...
                            <div class="form_group">
                                ...
                                <input type="radio" id="man"
                                       <c:if test="${user.sex==1}">checked='checked'</c:if> value="1" name="sex"><label
                                    for="man">男</label>
                                <input type="radio" id="woman"
                                       <c:if test="${user.sex==2}">checked='checked'</c:if> value="2" name="sex"><label
                                    for="woman">女</label>
                            </div>
                            <div class="form_group">
