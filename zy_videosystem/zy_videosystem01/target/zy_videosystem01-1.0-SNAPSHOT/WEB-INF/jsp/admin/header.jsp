      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li <c:if test='${param.fromJsp=="state"}'>class="active"</c:if>><a href="admin/state/courseavg.action">统计分析</a></li>
          </ul>
          
          <ul class="nav navbar-nav navbar-right">
        <li><a href="admin/logout.do" title="点击退出登录">${sessionScope.session_admin.loginName }<i class="glyphicon glyphicon-log-out" aria-hidden="true"></i></a></li>
      </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
