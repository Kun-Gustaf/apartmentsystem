...
<div class="container">
    ...
    <form class="form-horizontal" action="admin/course/saveOrUpdate.action" method="post">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="subjectId" id="subjectId">
                    ...
                    <c:forEach items="${subjects}" var="su">
                        <option value="${su.id }"
                                <c:if test="${su.id==course.subjectId} }">selected</c:if> >${su.subjectName }</option>
                    </c:forEach>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="courseName" id="courseName" value="${course.courseName }"
                       placeholder="课程标题">
            </div>
        </div>
        <div class="form-group">
