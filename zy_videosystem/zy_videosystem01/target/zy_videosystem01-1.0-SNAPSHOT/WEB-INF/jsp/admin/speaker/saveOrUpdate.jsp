...
<div class="container">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/speaker/saveOrUpdate.action" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speakerJob" id="speakerJob" value="${speaker.speakerJob }"
                       placeholder="主讲人职业">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speakerHeadUrl" id="speakerHeadUrl"
                       value="${speaker.speakerHeadUrl }" placeholder="主讲人头像地址，网络图片">
            </div>
        </div>
        <div class="form-group">
            <label for="speakerDesc" class="col-sm-2 control-label">简介</label>
            <div class="col-sm-10">
                <textarea class="form-control" name="speakerDesc" id="speakerDesc"
                          rows="3">${speaker.speakerDesc}</textarea>
            </div>
        </div>
        <div class="form-group">
