...
public class MailUtil {
    //修改为自己的qq邮箱账号
    private static String myEmailAccount = "1792941407@qq.com";

    //修改为自己的邮箱授权码 发送邮件协议的授权码 POP3/SMTP服务
    private static String myEmailPassword  = "eaygnchiqihsdjgi";
        /*IMAP/SMTP服务         bmzhnzjnkqvkbcjf*/
    //如果用qq邮箱不用修改，如果用163邮箱，修改为smtp.163.com
    private static String myEmailSMTPHost = "smtp.qq.com"; //QQ的发邮件服务器
    //用户名
    private static String sendUser = "阿玉";
